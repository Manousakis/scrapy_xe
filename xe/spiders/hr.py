...
class hr(CrawlSpider):
    name = "hr"
    download_delay = 2
    allowed_domains = ["xe.gr"]

    start_urls = ["http://www.xe.gr/property/search?Publication.age=1&System.item_type=re_residence&Transaction.type_channel=117541&page=1&per_page=50"]
